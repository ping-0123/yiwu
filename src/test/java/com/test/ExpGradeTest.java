...
public class ExpGradeTest {
	...
	@Test 
	public void addLowestAndHigthestExpGrade(){
		ExpGrade low = expGradeService.get(4000014);
		low.setLowestGrade(true);
		ExpGrade hi = expGradeService.get(4000000);
		hi.setHighesGrade(true);
		expGradeService.update(low);;
		expGradeService.update(hi);
	}
}
