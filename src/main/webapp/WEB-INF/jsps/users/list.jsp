		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					&nbsp&nbsp&nbsp
					<button class="btn btn-primary btn-sm" onclick="saveUserRoles()">
						<small>保存</small>
					</button>
			...
			"columns" : [
					...
					},
					{
						...
						"render" : function(data, type, row, meta) {
							...
							html = html
									+ '<a href="#" onclick="showUserRoles('
									+ row.id
									+ ')" data-toggle="modal" data-target=".modal-setting"> <i class="fa fa-navicon" title="设置用户角色"></i></a>';
							</shiro:hasPermission>
