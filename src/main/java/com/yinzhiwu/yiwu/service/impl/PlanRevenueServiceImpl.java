...
public class PlanRevenueServiceImpl implements PlanRevenueService {
	...
	public PlanRevenueApiModel getStoreMonthlyPlanRevenue(int storeId, int productType, int year, int month) {
		return new PlanRevenueApiModel(departmentDao,
				prDao.findStoreMonthlyPlanRevenue(storeId, productType, year, month));
	}
	...
	public List<PlanRevenueApiModel> getDistricMonthlyPlanRevenue(int districtId, int year, int month,
		...
		for (Department store : stores) {
			plans.add(new PlanRevenueApiModel(departmentDao,
	...
	public PlanRevenueApiModel get(int id) {
		try {
			return new PlanRevenueApiModel(departmentDao, prDao.get(id));
		} catch (Exception e) {
			return null;
		}
	}
	...
	@Override
	public List<PlanRevenueApiModel> findByProperties(int storeId, int year, int month, int productTypeId) {
		List<PlanRevenueApiModel> planModels = new ArrayList<>();
