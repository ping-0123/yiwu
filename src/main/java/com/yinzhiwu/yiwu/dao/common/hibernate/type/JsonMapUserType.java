package com.yinzhiwu.yiwu.dao.common.hibernate.type;
...
//        }
        Map<Object, Object> map = new Gson().fromJson(json, Map.class);
        return new JsonMap(map);
    }
...
//                throw new HibernateException(e);
//            }
            st.setString(index, new Gson().toJson(value));
        }
    }
