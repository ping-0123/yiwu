...
public class IncomeRecordApiController extends BaseController{
	 ...
	 * @param eventTypeId	事件类型Id {@link com.yinzhiwu.yiwu.entity.type.EventType}
	 * @param relationTypeId	事件当事人与收益人的关系  {@link com.yinzhiwu.yiwu.entity.type.RelationType}
	 * @return
	 */
	@GetMapping("/list")
	 ...
	 * 根据收益类型获取收益记录数量
	 * @param distributerId 
	 * @param incomeTypeIds 收益类型Id数组 {@link com.yinzhiwu.yiwu.entity.type.IncomeType}
	 * @return
	 */
