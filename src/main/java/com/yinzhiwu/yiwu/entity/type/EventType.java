...
public class EventType extends BaseType {
	...
	public static final EventType REGISTER_WITHOUT_INVATATION_CODE = new EventType(10003,
	...
	public static final EventType SHARE_TWEET_BY_WECHAT_FIRST_THREE_TIMES_PER_DAY = new EventType(10005,
			"SHARE_TWEET_BY_WECHAT_FIRST_THREE_TIMES_PER_DAY");
	public static final EventType SHARE_TWEET_BY_WECHAT_AFTER_THREE_TIMES_PER_DAY = new EventType(10006,
